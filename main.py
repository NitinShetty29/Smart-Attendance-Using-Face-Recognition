...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'nitinshetty2942@gmail.com' ")
...
def TakeImages():
    ...
    with open("StudentDetails\StudentDetails.csv", 'r') as csvFile:
        ...
        for row in reader:
            if row and row[2] == Id:
                mess._show(title='ID Already Exists', message='The entered ID already exists. Please enter a unique ID.')
                return
